...
for i in range(0, 200):
    ...
    rand.append(score(basewords, randwords))
    ...
    t1s.append(score(basewords, t1secondwords))
    ...
    t2s.append(score(basewords, t2secondwords))
...
df.to_csv('firm_t1second_vs_all_200_runs_50_neigh.csv')
